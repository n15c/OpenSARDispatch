 ...
 */
final class Version20210402212530 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE opreport (id INT AUTO_INCREMENT NOT NULL, operation_id INT DEFAULT NULL, report_text LONGTEXT DEFAULT NULL, rating INT DEFAULT NULL, UNIQUE INDEX UNIQ_F56C6B7244AC3583 (operation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
